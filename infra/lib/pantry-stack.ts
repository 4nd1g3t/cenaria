...
export class PantryStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    const pantryPut = new NodejsFunction(this, 'PantryPutFn', {
      entry: path.join(__dirname, '..', 'services', 'pantry', 'src', 'pantry-put.ts'),
      ...commonFnProps,
    });

    const pantryPatch = new NodejsFunction(this, 'PantryPatchFn', {
      entry: path.join(__dirname, '..', 'services', 'pantry', 'src', 'pantry-patch.ts'),
      ...commonFnProps,
    });
